...
- [ ] `verify_collision` test should read `collision_meta.txt` and assert the _specific_ victim slot and name are in the `UnreachableByHash2` problem list, not just `unreachable_count > 0`.
